...
#define PRETRG_PREGATE_MINDIFF_PSD 8

#define PSD_PROBES_VER_2_AMC_FW_REL 6

#define EHISTO_NBITS_PSD 15
...
typedef struct {
	...
	/* new fields */
	CAEN_DGTZ_DPP_PSD_Event_t* events[MAX_CH];
...
int getDecodedWaveforms(Digitizer* dig, CAEN_DGTZ_DPP_PSD_Event_t* event, void* traceData[4], int* traceSize);
