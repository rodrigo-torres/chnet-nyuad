...
//        CAENDPP_InputRange_t inRange[2] = { CAENDPP_InputRange_9_5Vpp, CAENDPP_InputRange_9_5Vpp }; // @suppress("Symbol is not resolved")
...
//        }
	...
	CAENDPP_InputRange_t inRange;
        if (*(shared_memory4+1) == 0 || NULL) inRange = CAENDPP_InputRange_0_6Vpp; // @suppress("Symbol is not resolved")
        else if (*(shared_memory4+1) == 1) inRange = CAENDPP_InputRange_1_4Vpp; // @suppress("Symbol is not resolved")
        else if (*(shared_memory4+1) == 2) inRange = CAENDPP_InputRange_3_7Vpp; // @suppress("Symbol is not resolved")
        else if (*(shared_memory4+1) == 3) inRange = CAENDPP_InputRange_9_5Vpp; // @suppress("Symbol is not resolved")
...
*/
    ...
    if (*(shared_memory_cmd+100)) AcqRun = 1;
