...
enum class BaselineSamples : char {
  k0,
  k16,
  k64,
  k256,
...
struct DAQModeParameters {
  DAQModeParameters() {
    ...
    x_end_coordinate   = 0.;
    y_start_coordinate = 0.;
    y_end_coordinate   = 0.;
  }

  DAQMode mode;
  double timeout;
  double x_start_coordinate;
  double y_start_coordinate;
  double x_end_coordinate;
  double y_end_coordinate;
  double x_motor_step;
  double y_motor_step;
