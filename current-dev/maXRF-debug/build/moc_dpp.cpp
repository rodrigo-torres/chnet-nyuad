/****************************************************************************
** Meta object code from reading C++ file 'dpp.h'
**
...
#error "The header file 'dpp.h' doesn't include <QObject>."
...
void MainWindowDPP::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MainWindowDPP *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject MainWindowDPP::staticMetaObject = { {
    ...
    qt_meta_stringdata_MainWindowDPP.data,
    qt_meta_data_MainWindowDPP,
    qt_static_metacall,
    nullptr,
    nullptr
} };
