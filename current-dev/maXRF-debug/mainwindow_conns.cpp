...
// Connections for tab4
    int size = sizeof (scan_params) / sizeof (QDoubleSpinBox);
    for (int i = 0; i < size; i++)
    connect(scan_params[1], QOverload<double>::of(&QDoubleSpinBox::valueChanged), this, &MainWindow::scan_parameters);
