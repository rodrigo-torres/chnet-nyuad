      ...
      switch (motor_selected)
       {
        ...
        case(7): { //"VT75-600" 600mm code: 62309160

                  invia_comando_X(1,"SPA"," 622991701"); 
                  Sleeper::msleep(1200);
                  qDebug()<<"...loading general parameters for VT75-600 linear stage...";
                  Sleeper::msleep(1200);
                  qDebug()<<"...wait while finishing...";
                  Sleeper::msleep(1200);
                  qDebug()<<"...start loading specific parameters...";
                  Sleeper::msleep(500);
                  invia_comando_X(1,"SPA"," 1 1000"); // 1000 //primo numero canale SPA secondo numero valore
                  Sleeper::msleep(100);
                  invia_comando_X(1,"SPA"," 2 1000"); //1000
                  Sleeper::msleep(100);          
                  invia_comando_X(1,"SPA"," 3 200");  //200
                  Sleeper::msleep(100);         
                  invia_comando_X(1,"SPA"," 4 1000"); //1000 
                  Sleeper::msleep(100);
                  invia_comando_X(1,"SPA"," 14 500"); //2000 passo 
                  Sleeper::msleep(100);     
                  invia_comando_X(1,"SPA"," 15 1"); ////0.064285257
                  Sleeper::msleep(100);
                  invia_comando_X(1,"SPA"," 19 0");          
                  ...
                  invia_comando_X(1,"SPA"," 8 0.5");    //8 10 e 11 per ultimi senno' li ricambia 0.035156
                  Sleeper::msleep(100);
                  invia_comando_X(1,"SPA"," 10 150");   // velocita'
                  Sleeper::msleep(100);
                  invia_comando_X(1,"SPA"," 11 200");  //Accelerazione
                  Sleeper::msleep(100);
                  invia_comando_X(1,"SPA"," 117442049 MM");  //Unita'  117442049
                  Sleeper::msleep(100);
      ...
      switch (motor_selected)
       {
        case(1): { 
        	    ...
        	    XY_SPEED_doubleSpinBox->setMaximum(50);
       		    XY_SPEED_doubleSpinBox->setValue(10);
                  break;
                 }
        ...
        case(4): { 
	            MOVE_TO_X_doubleSpinBox->setMaximum(100);
	            MOVE_TO_X_doubleSpinBox->setValue(50);
        	    XY_SPEED_doubleSpinBox->setMaximum(20);
        	    XY_SPEED_doubleSpinBox->setMaximum(20);
       		    XY_SPEED_doubleSpinBox->setValue(10);
                  break;
                 }
        ...
        case(5): { 
        	    ...
        	    XY_SPEED_doubleSpinBox->setMaximum(100);
        	    XY_SPEED_doubleSpinBox->setMaximum(20);
       		    XY_SPEED_doubleSpinBox->setValue(10);
                  break;
                 }
        ...
        case(7): { 
        	    ...
        	    XY_SPEED_doubleSpinBox->setMaximum(50);
       		    XY_SPEED_doubleSpinBox->setValue(20);
       	           break;
                 }
