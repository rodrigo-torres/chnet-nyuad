...
static const char qt_meta_stringdata_Plot[] = {
    "Plot\0\0ChEn\0Energy_Channel_Choice(bool)\0"
    "constant\0Calibration(double)\0off\0"
    "Offset(double)\0timerRefreshEvent()\0"
    "Open()\0Check_SHM()\0showPixelHisto()\0"
    "Retta_Cal()\0ch1(double)\0ch2(double)\0"
    "E1(double)\0E2(double)\0"
};
...
void Plot::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->Energy_Channel_Choice((*reinterpret_cast< bool(*)>(_a[1]))); break;
