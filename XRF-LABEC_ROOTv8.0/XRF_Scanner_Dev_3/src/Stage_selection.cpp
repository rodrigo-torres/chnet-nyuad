      ...
      switch (Xmotortype)
       {
        ...
        case(7): {CurrentAction->setText("VT80-300"); motor_selectedX=Xmotortype; break;}
        case(8): {CurrentAction->setText("VT75-400"); motor_selectedX=Xmotortype; break;}
        case(9): {CurrentAction->setText("VT75-600"); motor_selectedX=Xmotortype; break;}
       }
}
      ...
      switch (Ymotortype)
       {
        ...
        case(7): {CurrentAction->setText("VT80-300"); motor_selectedY=Ymotortype; break;}
        case(8): {CurrentAction->setText("VT75-400"); motor_selectedY=Ymotortype; break;}
        case(9): {CurrentAction->setText("VT75-600"); motor_selectedY=Ymotortype; break;}
       }
}
