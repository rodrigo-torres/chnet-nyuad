...
double Integral[632025];  /////////// 795x795
int Xmap[632025], Ymap[632025]; 
double X[632025],Y[632025];

double Integral1[632025]={0}, Integral2[632025]={0}, Integral3[632025]={0};
...
double passoX_lcd=1, passoY_lcd=1;
...
double MaxXvalue=101, MaxYvalue=101, MinXvalue=99, MinYvalue=99;

double MapOffsetValue=1.5; int BGColor=0;  bool QuitProgram_bool=false;
