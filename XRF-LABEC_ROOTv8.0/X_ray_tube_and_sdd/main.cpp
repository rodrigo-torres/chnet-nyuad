...
//    w.resize(1160, 740);
      ...
      switch (Resolution_mode)
       {
        case(0): {w.resize( 760, 580  ); w.setMinimumSize (760, 580); w.setMaximumSize(760, 580); break;}
...
//        case(2): {w.resize( 380, 300  ); break;}
    ...
    w.setWindowTitle(QApplication::translate("childwidget", "X-Ray & Detector HV Controller"));
    w.show();
