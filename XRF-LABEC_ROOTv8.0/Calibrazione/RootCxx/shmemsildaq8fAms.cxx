...
{ DoDrawInProgress=true; 
  ...
  if(Histo)             
	...
	min=int(ZoomMin*CalFactor); max=int(ZoomMax*CalFactor); amp=ZoomAmp;}//amp=int(ZoomAmp*CalFactor); if (amp<64) amp=64;}
      else {min=ZoomMin; max=ZoomMax; amp=ZoomAmp; if (amp<64) amp=64;}
