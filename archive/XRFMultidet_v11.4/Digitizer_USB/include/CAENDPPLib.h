...
*/
int32_t CAENDPP_API CAENDPP_InitLibrary(int32_t * handledpp);
...
- return : 0 for success otherwise an error code.
*/
int32_t CAENDPP_API CAENDPP_EndLibrary(int32_t handledpp);
...
- return : 0 for success otherwise an error code.
*/
int32_t CAENDPP_API CAENDPP_AddBoard(int32_t handledpp, CAENDPP_ConnectionParams_t connParams, int32_t *boardId);
...
- return : 0 for success otherwise an error code.
*/
int32_t CAENDPP_API CAENDPP_GetDPPInfo(int32_t handledpp, int32_t boardId, CAENDPP_Info_t* info);
...
- return : 0 for success otherwise an error code.
*/
int32_t CAENDPP_API CAENDPP_StartBoardParametersGuess(int32_t handledpp, int32_t boardId, uint32_t channelMask, const CAENDPP_DgtzParams_t *Params);
...
- return : 0 for success otherwise an error code.
*/
int32_t CAENDPP_API CAENDPP_EnableSwTriggers(int32_t handle);
...
- return : 0 for success otherwise an error code.
*/
int32_t CAENDPP_API CAENDPP_DisableSwTriggers(int32_t handle);
...
- return : 0 for success otherwise an error code.
*/
int32_t CAENDPP_API CAENDPP_GetHVStatusString(uint16_t status, char *statusString);
